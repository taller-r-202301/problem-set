...
-   Recuerde hacer fork sobre el repositorio [https://github.com/taller-r-202301/pset-1](https://github.com/taller-r-202202/pset-1){.uri} para que cree una versión del repositorio en su cuenta de GitHub. Si va a trabajar en grupo, solo 1 integrante del grupo debe hacer fork del repositorio y compartir el acceso a los demás integrantes. Este repositorio debe incluir a lo menos tres carpetas: `input` (datos originales), `output` (datos procesados) y `code` (script con la respuesta del taller).

-   Deberá colgar en Bloque Neón el link al repositorio de GitHub antes de las 23:59 horas del 18 de septiembre de 2022.
...
Los siguientes puntos se llevaran a cabo con la [Encuesta de Micronegocios- 2021](https://microdatos.dane.gov.co/index.php/catalog/742/get-microdata), la cual se enfoca en las empresas que desarrollan una actividad económica con un máximo de 9 personas ocupadas. El diccionario de datos lo encontrara virtual en el portal del [DANE](https://microdatos.dane.gov.co/index.php/catalog/742/data-dictionary) o lo podrá descargar en formato [pdf](https://microdatos.dane.gov.co/index.php/catalog/742/download/21404).
...
-   Sobre el objeto que contiene la base `Identificación`, genere una variable que sera igual a: **Agricultura** cuando sea **igual a 1**, **Industria manufacturera** cuando sea **igual a 2**, **comercio** cuando sea **igual a 3** y servicios cuando sea **igual a 4**. a esta variable le llamara `bussiness_type`.
